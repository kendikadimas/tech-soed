export const t = {
    id: {
        ...
        heroTitle1: "Jasa Pembuatan Website & Aplikasi Terpercaya.",
        heroTitle2: "Solusi Digital Tepat untuk Skala Bisnis Anda.",
        heroDesc: "TechSoed adalah Software House spesialis web development, aplikasi mobile, UI/UX design, dan digital marketing. Ciptakan inovasi teknologi bersama tim web developer berpengalaman untuk menjangkau lebih banyak pelanggan di ranah digital.",
        ...
        aboutDesc: "Bukan sekadar jasa buat website biasa. TechSoed adalah mitra teknologi strategis Anda di Purwokerto yang merancang produk digital mulai dari Company Profile, E-Commerce, LMS, hingga kampanye Sosial Media yang sudah teroptimasi SEO (Search Engine Optimization) secara penuh.",
        ...
        ctaDesc: "Jangan biarkan kompetitor selangkah di depan. Konsultasikan ide aplikasi atau kebutuhan website Anda kepada TechSoed. Tim ahli kami siap memberikan solusi e-commerce, CMS, dan strategi digital dengan garansi kualitas terbaik.",
        ctaBtn: "Hubungi Tim Ahli Kami",
        footerDesc: "TechSoed merupakan Software House & Digital Agency di Purwokerto yang berfokus pada jasa pembuatan website, pengembangan aplikasi mobile, UI/UX design, dan strategi digital marketing berkinerja tinggi yang dirancang untuk SEO.",
    ...
    en: {
        ...
        heroTitle1: "Professional Web & Mobile App Development.",
        heroTitle2: "Digital Solutions to Scale Up Your Business.",
        heroDesc: "TechSoed is a premier Software House specializing in custom website development, mobile apps, UI/UX design, and digital marketing. Innovate with our expert software developers to reach global customers and skyrocket your revenue.",
        ...
        aboutDesc: "TechSoed goes beyond basic web development services. We are a strategic technology partner engineering robust digital products from scratch. Experience the power of custom Company Profiles, seamless E-Commerce, LMS, and fully SEO-optimized digital branding.",
        aboutSvc1Title: "Web Development",
        aboutSvc2Title: "UI/UX Design",
        aboutSvc3Title: "Digital Branding",
        aboutSvc4Title: "Social Media",
        ...
        ctaDesc: "Don't let competitors stay one step ahead. Consult your app ideas or website needs with TechSoed. Our expert team is ready to provide e-commerce solutions, CMS, and digital strategies with guaranteed premium quality.",
        ctaBtn: "Contact Our Expert Team",
        footerDesc: "TechSoed is a Software House & Digital Agency specializing in high-performance web development, mobile app creation, UI/UX design, and SEO-driven digital marketing strategies.",
