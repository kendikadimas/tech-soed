export const t = {
    id: {
        ...
        heroDesc: "TechSoed menyediakan spesialisasi layanan jasa pembuatan website, jasa pembuatan aplikasi mobile, UI/UX design, dan pembaruan sistem informasi. Ciptakan inovasi teknologi bersama tim handal kami untuk menjangkau lebih banyak pelanggan di ranah digital.",
        ...
        ctaDesc: "Jangan biarkan kompetitor selangkah di depan. Konsultasikan ide proyek perancangan aplikasi atau kebutuhan jasa pembuatan website Anda kepada TechSoed. Kami siap memberikan solusi e-commerce, sistem CMS, dan strategi digital dengan garansi kualitas terbaik.",
        ctaBtn: "Hubungi Tim Ahli Kami",
        footerDesc: "TechSoed merupakan agensi spesialis jasa pembuatan website, pengembangan aplikasi mobile, CMS, sistem informasi terintegrasi, serta layanan UI/UX dan digital marketing berkinerja tinggi yang dirancang untuk SEO.",
    ...
    en: {
        ...
        heroDesc: "TechSoed provides specialized services in website development, mobile app creation, UI/UX design, and information system engineering. Build technological innovations with our reliable team to reach more digital customers.",
        ...
        aboutDesc: "More than just a standard digital agency. TechSoed is your strategic technology partner based in Purwokerto, offering premium information system creation (CMS, LMS), POS & E-Commerce applications, custom landing pages, and fully SEO-optimized social media campaigns.",
        aboutSvc1Title: "Web Development",
        aboutSvc2Title: "UI/UX Design",
        aboutSvc3Title: "Digital Branding",
        aboutSvc4Title: "Social Media",
        ...
        ctaDesc: "Don't let competitors stay one step ahead. Consult your application ideas or professional website creation needs with TechSoed. We are ready to provide robust e-commerce and CMS solutions with guaranteed premium quality.",
        ctaBtn: "Contact Our Expert Team",
        footerDesc: "TechSoed is a premier agency specializing in high-performance website creation, mobile app development, integrated information systems (CMS), and SEO-driven digital marketing strategies.",
