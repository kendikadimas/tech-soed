          ...
          >
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              ...
              <div>
                ...
                <textarea required value={form.projectDesc} onChange={e => setForm({ ...form, projectDesc: e.target.value })} rows={3} className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition resize-none" placeholder="..." />
              </div>
              <div className="pt-2 flex gap-3">
                <button type="button" onClick={onClose} className="px-6 py-3.5 rounded-xl font-bold text-slate-600 bg-slate-100 hover:bg-slate-200 transition">
                  {t[lang].orderFormCancel}
                </button>
                <button type="submit" className="flex-1 px-6 py-3.5 rounded-xl font-bold text-white bg-[#25D366] hover:bg-[#20bd5a] shadow-lg shadow-[#25D366]/30 transition flex items-center justify-center gap-2">
