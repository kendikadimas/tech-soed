...
export default function CtaSection() {
  ...
  return (
    <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-12 bg-slate-50 dark:bg-slate-950 transition-colors relative overflow-hidden">
      <motion.div
        initial={{ opacity: 0, scale: 0.95 }}
        whileInView={{ opacity: 1, scale: 1 }}
        viewport={{ once: true }}
        transition={{ duration: 0.6 }}
        className="max-w-5xl mx-auto relative bg-blue-900 rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-10 lg:p-16 text-center shadow-2xl shadow-blue-900/20"
      >
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-indigo-100 font-medium mb-7 sm:mb-8 max-w-sm sm:max-w-2xl opacity-90 leading-relaxed text-pretty">
            {t[lang].ctaDesc}
          </p>
