      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <a
            ...
            className="group inline-flex items-center justify-center gap-3 px-10 py-4 bg-white text-blue-900 font-black rounded-2xl hover:bg-slate-50 transition-all shadow-xl hover:-translate-y-1 active:scale-95"
          >
