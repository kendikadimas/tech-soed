        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-16">
          ...
          <div className="space-y-8">
            ...
            <ul className="space-y-6">
              <li>
                <a
                  href="https://maps.google.com/?q=Purwokerto%2C%20Jawa%20Tengah%2C%20Indonesia"
                  target="_blank"
                  rel="noreferrer"
                  className="group flex items-start gap-4"
                >
                  <div className="w-10 h-10 rounded-xl bg-slate-800 flex items-center justify-center text-indigo-400 shrink-0 group-hover:bg-slate-700 transition-colors">
                    <MapPin className="w-5 h-5" />
                  </div>
                  <div className="text-sm font-medium text-slate-400 group-hover:text-white transition-colors leading-relaxed">
              ...
              <li>
                <a
                  href="https://wa.me/6285814174267?text=Halo%20TechSoe%2C%20saya%20ingin%20konsultasi%20project."
                  target="_blank"
                  rel="noreferrer"
                  className="group flex items-center gap-4"
                >
                  <div className="w-10 h-10 rounded-xl bg-slate-800 flex items-center justify-center text-[#25D466] shrink-0 group-hover:bg-slate-700 transition-colors">
              ...
              <li>
                <a href="mailto:hi@techsoe.com" className="group flex items-center gap-4">
                  <div className="w-10 h-10 rounded-xl bg-slate-800 flex items-center justify-center text-indigo-400 shrink-0 group-hover:bg-slate-700 transition-colors">
